...
Build a personal AI assistant using Gemini API as the intelligence engine
...
Provide a chat-style UI using Streamlit
...
.env and venv/ ignored using .gitignore

No API logic inside app.py

Clean separation of UI and AI logic

# 🛠 Tech Stack:  Python 3.11+ , Streamlit , Google Gemini API(2.5 flash), python-dotenv , JSON-based memory, OOP Architecture
## 🌟 Optional / Bonus Features Implemented

Dark / Light mode toggle

Animated sidebar branding

Role-based assistant behavior

Clean UI customization using CSS
